    ...
    <>
      <div>
        ...
        <section className={styles.hero}>
          ...
          >
            {heroSectionData.media.map((item) => {
                      ...
                      <div className={styles.heroLayout}>
                        <div className={styles.heroContent}>
                          ...
                          <div className={styles.heroActions}>
                            ...
                            <Link className="btn-watch" to={`/info/${item.id}`}>Anime info <span className="material-symbols-rounded text-icon" aria-hidden="true">arrow_forward</span></Link>
                          </div>
                        </div>
                      </div>
                    </>
          ...
          {/* indicators live OUTSIDE the swiper track so they never inherit slide transforms */}
